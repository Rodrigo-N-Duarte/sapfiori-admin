		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Report",
									"targetURL": "#brcomfioriappreport356-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomfioriappreport356-display": {
								"semanticObject": "brcomfioriappreport356",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.fioriappadmin356",
									"url": sap.ui.require.toUrl("br/com/fioriappadmin356")
								}
							}
						}
					}
